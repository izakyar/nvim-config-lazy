...
require("lazy").setup({
    ...
    { "simrat39/rust-tools.nvim" },   -- Rust tools (already included for Rust)
...
require("mason-lspconfig").setup {
    ensure_installed = { "rust_analyzer", "clangd" }, -- Add clangd for C/C++
}

-- LSP configuration (rust-analyzer and clangd)
...
require("nvim-treesitter.configs").setup {
    ensure_installed = { "rust", "c", "cpp" }, -- Add C/C++ parsers
